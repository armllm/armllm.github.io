...
const hackathonFAQ: FAQCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'It runs <strong>August 8–9, 2026</strong> at the <strong>AI9 Startup Campus</strong> in Yerevan — kickoff Saturday at 10:00, 24 hours of building, then <strong>Demo Day on Sunday at 13:00</strong> with the awards right after.',
      },
      {
    ...
    <div>
      ...
      <section className="relative pt-32 pb-20 border-b border-white/10 overflow-hidden">
        <div className="container mx-auto px-8 text-center">
          ...
          <p className="text-accent font-medium mb-8">
            August 8–9, 2026 · Sat 10:00 → Sun afternoon · 24 hours of building · AI9 Startup Campus, Yerevan
          </p>
        ...
        <div className="container mx-auto px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              ...
              <p className="text-white/80 text-sm">August 8–9, 2026 — from Sat 10:00, with 24 hours of building; Demo Day Sun 13:00.</p>
            </Card>
            <Card>
      ...
      <section className="py-20 bg-glass border-b border-white/10">
        <div className="container mx-auto px-8">
          <SectionTitle
            title="The 24 Hours"
            subtitle="From Saturday 10:00 — 24 hours of building, then Demo Day at 13:00 on Sunday"
          />
