    ...
    items: [
      {
        ...
        answer: "<ul><li><strong>In-person:</strong> 150,000 AMD (or equivalent). Covers theoretical + practical sessions and includes GPU access.</li><li><strong>Online:</strong> $200 (or equivalent). Covers theoretical sessions; aid is distributed based on funding available.</li></ul>"
      },
      {
