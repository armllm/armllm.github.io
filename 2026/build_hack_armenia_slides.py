...
NUMBERS = [
    ...
    ("9", "jury members", "judging Demo Day"),
...
<div class="rule" style="margin:16px 0 20px"></div>
<div class="body"><div class="people" style="grid-template-columns:repeat(5,1fr);gap:13px">{jury}</div></div>''')
...
<div class="sub" style="font-size:17px;margin-top:8px">OpenAI is sponsoring the hackathon prizes with API credits.</div>
...
# 22 — special prize, announced separately from the OpenAI prizes
slide(f'''
<h2>Special <span class="ac">prize</span></h2>
<div class="sub" style="font-size:17px;margin-top:8px">A separate award, presented by Eleveight AI.</div>
<div class="rule" style="margin:16px 0 14px"></div>
<div class="body" style="flex-direction:row;align-items:center;justify-content:center;gap:52px">
  <img src="{uri("hackathon/prizes/prize-eleveight.jpg")}" alt="Special prize: 5000 USD equivalent GPUs from Eleveight AI"
       style="max-height:370px;width:auto;border-radius:18px;box-shadow:0 18px 50px rgba(0,0,0,.55)"/>
  <div style="max-width:440px">
    ...
    <div class="card-b" style="font-size:16px;margin-top:12px">
      <b>Eleveight AI</b> is presenting its own special prize at Hack Armenia — GPUs worth $5,000,
      so the winning team leaves with real compute to keep building.
    </div>
  </div>
</div>''')
